...
<div id="nav-wrap">
  <div id="nav">
    <ul>
          <li id="current"><a href="adminhome.jsp">Admin Home</a></li>
		  <li><a href="viewcitizen.jsp">View Registration</a></li>
		  <li><a href="admincompliantreport.jsp">See Complaints</a></li>
          <li><a href="fir.jsp">Book FIR</a></li>
		  <li><a href="addpolicestation1.jsp">Stations</a></li>
  ...
  <!-- footer ends-->
<div id="content-wrap">
<h1 align="left"><b>&nbsp&nbsp&nbspWelcome Admin.</b></h1>
  <div id="content">
    <div id="sidebar">
      <div class="sidebox">
      </div>
