...
<div id="nav-wrap">
  <div id="nav">
    <ul>
	  ...
	  <li id="current"><a href="adminupdatefir.jsp">UPDATE FIR</a></li>
...
<div class="box">
<center>
<form name="complaint" method="post" action="adminupdatefir3.jsp" onSubmit="return valid(this);">
<input type="hidden" name="fir">
<br>
<h1><img src="images\cp.png">Update FIR (First Information Report)</h1>
<table>
<tr>
