...
<div class="box">
<center>
<form name="viewfir" method="post" onsubmit="return validation(this);" action="adminviewfir2.jsp">
<br>
<table>
	<h2><img src="images\cp.png">FIR Report</h2>
	<tr>
		<td><input type="radio" name="r" value="all" checked>All FIR's
		<td>
	</tr>
	<tr>
		<td><input type="radio" name="r" value="ps" >Select Police Station
		<td><center><select name="psname" style="width:105%;">
