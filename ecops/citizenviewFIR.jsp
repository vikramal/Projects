...
<div id="nav-wrap">
  <div id="nav">
    <ul>
	  ...
	  <li id="current"><a href="citizenviewfir.jsp">View FIR</a></li>
...
<table width="100%">
	...
	<tr>
		...
		<td style="border:2px solid black;color:darkblue;">DATE of Information Recieved</td>
		<td style="border:2px solid black;color:darkblue;">ADDRESS (Place of occrence of crime)</td>
	...
	<%
		...
		ResultSet rs=st.executeQuery("select * from fir where name='"+x+"'");
		while(rs.next())
		{
			fir=rs.getString(1);
