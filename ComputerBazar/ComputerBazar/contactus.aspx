<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="contactus.aspx.cs" Inherits="ComputerBazar.contactus" %>
					...
					<div id="content">
						...
						<div class="post">
							...
							<h2 style="font-size: small">
                                <asp:Label ID="RetID_lbl0" runat="server" Font-Bold="True" Font-Size="X-Large" 
                                    ForeColor="#7EFF00" Text="Contact us" Font-Underline="True"></asp:Label>
                                <br />
                                <br />
                                <br />
                                <asp:Label ID="RetID_lbl1" runat="server" Font-Bold="True" Font-Size="Large" 
                                    ForeColor="#7EFF00" Text="Mr. Vikram AL"></asp:Label>
                                <br />
                                For Trade/Business Related Enquiries Seller/Distributor/Publisher/Author<br />
                                Register Number: 11NCJB643<br />
                                Email: <a href="mailto:vendor@ComputerBazar.com">vendor@ComputerBazar.com</a><br />
                                Contact Number: 8123500958.<br />
                                <br />
                                <asp:Label ID="RetID_lbl2" runat="server" Font-Bold="True" Font-Size="Large" 
                                    ForeColor="#7EFF00" Text="Mr. Varun V"></asp:Label>
                                <br />
                                For Business Queries
                                <br />
                                Register Number: 11NCJB615<br />
                                Email: <a href="mailto:business@ComputerBazar.com">business@ComputerBazar.com</a><br />
                                Contact Number: 8095064431.<br />
                                Affiliate Related Queries Email: <a href="mailto:affiliate@ComputerBazar.com">
                                affiliate@ComputerBazar.com</a><br />
                                <br />
                                <asp:Label ID="RetID_lbl3" runat="server" Font-Bold="True" Font-Size="Large" 
                                    ForeColor="#7EFF00" Text="Mr. Manohar"></asp:Label>
                                <br />
                                Computer Bazar Internet Private Limited,   <br />
                                Computer Bazar Internet Private Limited,<br />
                                Register Number: 11NCJB637<br />
                                Email: <a href="mailto:Internet@ComputContact Number: 9742930942.<br />
                            </h2>
						</div>
						<!-- End Post -->
						<!-- Begin Products -->
