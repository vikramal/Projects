<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="customerhome.aspx.cs" Inherits="ComputerBazar.customerhome" %>
		...
		<div id="navigation">
			<div class="shell">
				<ul>
                    ...
                    <li><a href="bill.aspx" title="Bill">Bill</a></li>
			...
			<div class="inner">
				<div class="shell">
							...
							<li class="widget">
								...
								<div class="widget-entry">
									<ul>
										...
										<li><a href="speakers.aspx" title="Speakers"><span>Speakers</span></a></li>
					...
					<div id="content">
						<!-- Begin Post -->
						<div class="post">
							<h2 style="color: #72E107">Welcome to ComputerBazar.com</h2>
						</div>
						<!-- End Post -->
						<!-- Begin Products -->
						<div id="products">
							<h2 align="center">
                                <asp:Label ID="welcome_lbl" runat="server" ForeColor="#7EFF00"></asp:Label>
                                </h2>
                  			<div class="cl">&nbsp;</div>
						</div>
						<!-- End Products -->
