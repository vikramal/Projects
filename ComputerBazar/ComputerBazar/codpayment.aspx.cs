...
{
    public partial class codepayment : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            SqlCommand cmd = new SqlCommand("select * from codpurchase where uname='"+ x +"'", con);
        ...
        protected void finish_btn_Click(object sender, EventArgs e)
        {
            ...
            {
                SqlConnection con = new SqlConnection(s);
                SqlCommand cmd1 = new SqlCommand("update codpurchase set status=' confirmed ' where phno='" + phno + "'", con);
                cmd1.Connection = con;
                con.Open();
                ...
                sp.Write("Hello " + name + " Your Cash on Delivery of ORDER NO: "+orderno+" has been confirmed  " + char.ConvertFromUtf32(26) + char.ConvertFromUtf32(13));
                sp.Close();
                Session["total"] = 0;
