<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="customerchangepassword.aspx.cs" Inherits="ComputerBazar.custchangepassword" %>
		...
		<div id="main">
            ...
            <tr>
                <td align="center" class="style3" colspan="2">
                    <asp:Label ID="error_lbl" runat="server" Font-Bold="True" Font-Names="Tahoma" 
                        Font-Size="X-Large"></asp:Label>
                </td>
            </tr>
            <tr>
                <td align="center">
                    <asp:Label ID="retcurrentpass_lbl" runat="server" Font-Bold="True" Font-Size="Large" 
                        Text="Current Password"></asp:Label>
                </td>
                <td>
                    <asp:TextBox ID="retcurrentpass_txt" runat="server" TextMode="Password" 
                        Width="150px"></asp:TextBox>
                                            <asp:RequiredFieldValidator ID="current_req" runat="server" 
                                                ControlToValidate="retcurrentpass_txt" 
                        ErrorMessage="!!Cannot Be Blank"></asp:RequiredFieldValidator>
                </td>
            </tr>
            <tr>
                <td align="center">
                    <asp:Label ID="retpass_lbl" runat="server" Font-Bold="True" Font-Size="Large" 
                        Text="New Password"></asp:Label>
                </td>
                <td>
                    <asp:TextBox ID="retpass_txt" runat="server" TextMode="Password" Width="150px"></asp:TextBox>
                                            <asp:RequiredFieldValidator ID="new_req" runat="server" 
                                                ControlToValidate="retpass_txt" 
                        ErrorMessage="!!Cannot Be Blank"></asp:RequiredFieldValidator>
                </td>
            </tr>
            <tr>
                <td align="center" class="style2">
                    <asp:Label ID="retrepass_lbl" runat="server" Font-Bold="True" Font-Size="Large" 
                        Text="Re-type Password"></asp:Label>
                </td>
                <td class="style2">
                    <asp:TextBox ID="retrepass_txt" runat="server" TextMode="Password" 
                        Width="150px"></asp:TextBox>
                                            <asp:RequiredFieldValidator ID="retypenew_req" runat="server" 
                                                ControlToValidate="retrepass_txt" 
                        ErrorMessage="!!Cannot Be Blank"></asp:RequiredFieldValidator>
                                            <asp:CompareValidator ID="repass_comp" runat="server" 
                                                ControlToCompare="retpass_txt" ControlToValidate="retrepass_txt" 
                                                
                        ErrorMessage="!!! Password &amp; Re-type Password Should be same"></asp:CompareValidator>
                </td>
            </tr>
            <tr>
                <td align="center">
                ...
                <td>
                                            <asp:Button ID="retchange_but" runat="server" 
