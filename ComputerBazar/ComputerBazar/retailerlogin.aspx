<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="retailerlogin.aspx.cs" Inherits="ComputerBazar.retailerlogin" %>
				...
				<div class="shell">
					...
					<div id="content">
						...
						<div class="post">
							...
							<p style="color: rgb(169, 169, 169); font-family: Tahoma; font-size: 11px; font-style: normal; font-variant: normal; font-weight: normal; letter-spacing: normal; line-height: 16px; orphans: auto; text-align: start; text-indent: 0px; text-transform: none; white-space: normal; widows: auto; word-spacing: 0px; -webkit-text-stroke-width: 0px; background-color: rgb(54, 54, 54); display: inline !important; float: none;">
                                &nbsp;</p>
						</div>
						<!-- End Post -->
						<!-- Begin Products -->
						<div id="products">
							<h2 align="center" style="color: #8CB622; font-size: larger;">
                                <asp:Label ID="welcome_lbl" runat="server" Font-Size="X-Large" 
                                    ForeColor="#7EFF00"></asp:Label>
                                </h2>
                            <div>
                                    ...
                                    <tr>
                                        <td class="style2">
                                            <asp:Label ID="retname_lbl" runat="server" Font-Bold="True" Font-Names="Tahoma" 
                                                Font-Size="Medium" Text="Retailer Name" ForeColor="#93C123"></asp:Label>
                                        </td>
                                        <td>
                                            &nbsp;
                                            ...
                                            &nbsp;<asp:RequiredFieldValidator ID="id_req" runat="server" 
                                                ...
                                                ToolTip="Enter Retailer name"></asp:RequiredFieldValidator>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td class="style3">
                                            <asp:Label ID="retpass_lbl" runat="server" Font-Bold="True" Font-Names="Tahoma" 
                                                Font-Size="Medium" Text="Retailer Password" ForeColor="#93C123"></asp:Label>
                                        </td>
                                        <td class="style3">
                                            &nbsp;
