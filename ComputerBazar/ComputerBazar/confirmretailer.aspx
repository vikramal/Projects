<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="confirmretailer.aspx.cs" Inherits="ComputerBazar.confirmretailer" %>
						...
						<div class="post">
							<h2 align="center">
                                ...
                                <asp:Label ID="title_lbl" runat="server" Font-Bold="True" Font-Names="Tahoma" 
                                    Font-Size="Large">Confirm Retailer</asp:Label>
                                <br />
                            </h2>
						</div>
						<!-- End Post -->
                            ...
                            <div>
                                <table align="center" class="style1">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <asp:Button ID="confirm_but" runat="server" Font-Bold="True" Font-Names="Tahoma" 
                                                Font-Size="Medium" Text="CONFIRM" onclick="product" />
                                        </td>
                                    </tr>
                                    </table>
