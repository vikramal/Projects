<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="speakers.aspx.cs" Inherits="ComputerBazar.speakers" %>
			...
			<div class="inner">
				<div class="shell">
					...
					<div id="content">
						<!-- Begin Post -->
						<div class="post">
							<h2 style="color: #7AF303">Welcome to ComputerBazar.com</h2>
						</div>
                        <div>

                            <asp:CheckBox ID="price10" runat="server" 
                                oncheckedchanged="price10_CheckedChanged" Text="10000-20000" />
