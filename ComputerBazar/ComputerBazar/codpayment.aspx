<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="codpayment.aspx.cs" Inherits="ComputerBazar.codepayment" %>
...
<body>
	...
	<div id="wrapper">
		...
		<div id="header" class="shell">
			<h1 id="logo"><a class="notext" href="#" title="Computre Bazar">Computer Bazar</a></h1>
		</div>
		<!-- End Header -->
		<!-- Begin Navigation -->
		<div id="navigation">
                        ...
                        <div>          
                            <table class="style1">
                                ...
                                <tr>
                                    ...
                                    <td class="style6">
                                        &nbsp;&nbsp;
                                        <asp:TextBox ID="phno_txt" runat="server" Width="215px"></asp:TextBox>
                                        <asp:RequiredFieldValidator ID="phno_req" runat="server" 
                                            ControlToValidate="phno_txt" ErrorMessage="*" Font-Bold="True" 
                                ...
                                <tr>
                                    ...
                                    <td class="style8">
                                        &nbsp;&nbsp;
                                        <asp:TextBox ID="code_txt" runat="server" Width="215px"></asp:TextBox>
                                        <asp:RequiredFieldValidator ID="code_req" runat="server" 
                                            ControlToValidate="code_txt" ErrorMessage="*" Font-Bold="True" 
                                            Font-Names="Tahoma" Font-Size="Medium" ForeColor="Red" 
                                            ToolTip="Enter Phone number"></asp:RequiredFieldValidator>
                                    </td>
                                </tr>
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <asp:Button ID="finish_btn" runat="server" Font-Bold="True" Font-Names="Tahoma" 
                                            Font-Size="Medium" onclick="finish_btn_Click" Text="Finish" Width="86px" />
                                    </td>
                                </tr>
                            </table>
                        </div>
