...
namespace ComputerBazar
{
    public partial class deleteproduct : System.Web.UI.Page
    {
        ...
        protected void delete_but_Click(object sender, EventArgs e)
        {
            SqlConnection con2 = new SqlConnection(s);
            SqlCommand cmd2 = new SqlCommand("delete product where pid='" + this.pid_list.Text + "'", con2);
            cmd2.Connection = con2;
            con2.Open();
            cmd2.ExecuteNonQuery();
            con2.Close();
            this.message_lbl.Text = "Product Deleted Successfully";
        }
    }
}