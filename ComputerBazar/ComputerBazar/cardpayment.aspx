<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="cardpayment.aspx.cs" Inherits="ComputerBazar.cardpayment" %>
...
<body>
	...
	<div id="wrapper">
			...
			<div class="inner">
				<div class="shell">
					...
					<div id="content">
						<!-- Begin Post -->
						<div class="post">
							<h2 style="color: #7AF303" align="center">Card Payment<br />
                                <br />
                        ...
                        <div>          
                            <table class="style1">
                                <tr>
                                    <td class="style3" align="center" colspan="2">
                                        <asp:Label ID="viewcode_lbl" runat="server" 
                                            ...
                                            Text="Please Enter your Card Details and Phone Number" Font-Bold="True" 
                                ...
                                <tr>
                                    <td align="left" class="style5">
                                        <asp:Label ID="amount2_lbl" runat="server" Text="Amount Payable is " Font-Bold="True" 
                                            Font-Names="Tahoma" Font-Size="Medium" ForeColor="#79F402"></asp:Label>
                                    </td>
                                    <td class="style6">
                                        &nbsp;&nbsp;
                                ...
                                <tr>
                                    <td class="style5">
                                        <asp:Label ID="entercardnum_lbl" runat="server" Text="Enter Card Number" Font-Bold="True" 
                                            Font-Names="Tahoma" Font-Size="Medium" ForeColor="#79F402"></asp:Label>
                                    </td>
                                    <td class="style6">
                                        &nbsp;&nbsp;
                                        <asp:TextBox ID="cardnum_txt" runat="server" Width="215px" Font-Bold="True" 
                                            Font-Names="Tahoma" Font-Size="Medium" MaxLength="16"></asp:TextBox>
                                    &nbsp;&nbsp;
                                            <asp:RegularExpressionValidator ID="cardno_valid" runat="server" 
                                                ControlToValidate="cardnum_txt" ErrorMessage="!!" SetFocusOnError="True" 
                                                ToolTip="Please Enter a 16 Digit No." ValidationExpression="^[0-9]{16}$" 
                                ...
                                <tr>
                                    <td class="style7">
                                        <asp:Label ID="choseexp_lbl" runat="server" Text="Choose Expiry  Date" Font-Bold="True" 
                                            Font-Names="Tahoma" Font-Size="Medium" ForeColor="#79F402"></asp:Label>
                                    </td>
                                    <td class="style8" align="justify">
                                        &nbsp;&nbsp;&nbsp;&nbsp;
                                        <asp:TextBox ID="cardexpire_txt" runat="server" Width="215px" Font-Bold="True" 
                                            Font-Names="Tahoma" Font-Size="Medium" 
                                            ontextchanged="cardexpire_txt_TextChanged" ReadOnly="True"></asp:TextBox>
                                        <asp:Calendar ID="Calendar1" runat="server" Font-Bold="True" 
                                            onselectionchanged="Calendar1_SelectionChanged" ForeColor="#7EFF00"></asp:Calendar>
                                        <asp:RangeValidator ID="RangeValidator1" runat="server" 
                                            ControlToValidate="cardexpire_txt" 
                                            ErrorMessage="INVALID DATE  PLEASE CHECK EXPIRE DATE" Type="Date"></asp:RangeValidator>
                                    </td>
                                </tr>
                                <tr>
                                    <td class="style11">
                                        <asp:Label ID="name_lbl" runat="server" Text="Name On Card" Font-Bold="True" 
                                            Font-Names="Tahoma" Font-Size="Medium" ForeColor="#79F402"></asp:Label>
                                    </td>
                                    <td class="style9">
                                        &nbsp;&nbsp; 
                                        <asp:TextBox ID="cardname_txt" runat="server" Width="215px" 
                                            Font-Bold="True" Font-Names="Tahoma" Font-Size="Medium"></asp:TextBox>
                                    </td>
                                </tr>
                                <tr>
                                    <td class="style12">
                                        <asp:Label ID="cvvnum_lbl" runat="server" Text="CVV Number" Font-Bold="True" 
                                            Font-Names="Tahoma" Font-Size="Medium" ForeColor="#79F402"></asp:Label>
                                    </td>
                                    <td class="style10">
                                        &nbsp;&nbsp;
                                        <asp:TextBox ID="cvvnum_txt" runat="server" Width="215px" Font-Bold="True" 
                                            Font-Names="Tahoma" Font-Size="Medium" MaxLength="3" TextMode="Password"></asp:TextBox>
                                    &nbsp;&nbsp;
                                            <asp:RegularExpressionValidator ID="cvvno_valid" runat="server" 
                                                ControlToValidate="cvvnum_txt" ErrorMessage="!!" SetFocusOnError="True" 
                                                ToolTip="Please Enter a 3 Digit No." ValidationExpression="^[0-9]{3}$" 
                                                Font-Bold="True" Font-Names="Tahoma" Font-Size="Medium" 
                                            ForeColor="Red"></asp:RegularExpressionValidator>
                                    </td>
                                </tr>
                                <tr>
                                    ...
                                    <td class="style6">
                                        &nbsp;&nbsp;
                                        <asp:TextBox ID="phno_txt" runat="server" Width="215px" Font-Bold="True" 
                                    ...
                                    &nbsp;&nbsp;
                                            <asp:RegularExpressionValidator ID="phno_valid" runat="server" 
                                                ...
                                                ToolTip="Please Enter a 16 Digit No." ValidationExpression="^[0-9]{10}$" 
                                                Font-Bold="True" Font-Names="Tahoma" Font-Size="Medium" 
                                            ForeColor="Red"></asp:RegularExpressionValidator>
                                    </td>
                                </tr>
		...
		<div id="footer">
			<div class="shell">
				<p>Copyright &copy;ComputerBazar 2014. Design by: VMV Team. All Rights Reserved. hts Reserved. </p>
				<div class="cl">&nbsp;</div>
			</div>
		</div>
		<!-- End Footer -->
