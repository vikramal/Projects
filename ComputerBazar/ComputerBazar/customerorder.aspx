<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="customerorder.aspx.cs" Inherits="ComputerBazar.customerorder" %>
					...
					<div id="content">
                        ...
                        <div>
                            <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" 
                                CellPadding="4" ForeColor="#333333" GridLines="None" Width="763px" 
                                Height="235px">
                                <AlternatingRowStyle BackColor="White" ForeColor="#284775" />
                            <Columns>
                            <asp:BoundField DataField="orderid" HeaderText="Order ID" />
                            <asp:BoundField DataField="orderdate" HeaderText="Order Dare" />
                            ...
                            <asp:BoundField DataField="rname" HeaderText="Retialer name" />
