<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="customeraccount.aspx.cs" Inherits="ComputerBazar.customeraccount" %>
                                ...
                                <table class="style1">
                                    <tr>
                                        <td align="center" class="style3">
                                            <asp:Label ID="fname_lbl" runat="server" Font-Bold="True" Font-Names="Tahoma" 
                                    ...
                                    <tr>
                                        ...
                                        <td align="left">
                                            <asp:TextBox ID="landno_txt" runat="server" Font-Bold="True" 
                                                Font-Names="Tahoma" Font-Size="Medium" ReadOnly="True"></asp:TextBox>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td align="center" class="style3">
                                        ...
                                        <td align="left">
                                            <asp:TextBox ID="gender_txt" runat="server" Font-Bold="True" 
                                                Font-Names="Tahoma" Font-Size="Medium" ReadOnly="True"></asp:TextBox>
                                        </td>
                                    </tr>
                                    <tr>
                                    ...
                                    <tr>
                                        ...
                                        <td align="left" class="style6">
                                            <asp:Button ID="back_but" runat="server" Text="Back" Font-Bold="True" 
                                                Font-Names="Tahoma" Font-Size="Medium" onclick="back_but_Click" />
                                            </td>
                                    </tr>
                                </table>
