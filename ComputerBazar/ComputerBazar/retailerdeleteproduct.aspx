<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="retailerdeleteproduct.aspx.cs" Inherits="ComputerBazar.deleteproduct" %>
						...
						<div id="products">
                            ...
                            <h2 align="center">
                                            <asp:Label ID="Label1" runat="server" Font-Bold="True" Font-Names="Tahoma" 
                                                Font-Size="X-Large" Text="Delete Product" ForeColor="#77E906"></asp:Label>
                            </h2>
                            </div>
                                <table align="center" class="style1">
                                    ...
                                    <tr>
                                        ...
                                        <td align="center">
                                            &nbsp;
                                            <asp:Button ID="delete_but" runat="server" Height="29px" Text="Delete" 
                                                Width="76px" onclick="delete_but_Click" />
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                        </td>
                                    </tr>
                                </table>
