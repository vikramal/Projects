<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="customerlogin.aspx.cs" Inherits="ComputerBazar.customerlogin" %>
			...
			<div class="inner">
				<div class="shell">
					...
					<div id="content">
						...
						<!-- Begin Products -->
						<div id="products">
							<h2 align="center" style="color: #93C20F">Customer Log-in</h2>
                            <div>
                                    ...
                                    <tr>
                                        <td class="style2">
                                            <asp:Label ID="custname_lbl" runat="server" Font-Bold="True" Font-Names="Tahoma" 
                                                Font-Size="Medium" Text="Customer E-mail Address" ForeColor="#93C20F"></asp:Label>
                                        </td>
                                        <td>
                                            ...
                                            <asp:RequiredFieldValidator ID="id_req" runat="server" 
                                                ...
                                                ToolTip="Enter Customer E-mail Address"></asp:RequiredFieldValidator>
                                        &nbsp;&nbsp;&nbsp;&nbsp;
                                            <asp:RegularExpressionValidator ID="email_valid" runat="server" 
                                                ControlToValidate="name_txt" ErrorMessage="!!" SetFocusOnError="True" 
                                    ...
                                    <tr>
                                        <td class="style3">
                                            <asp:Label ID="custpass_lbl" runat="server" Font-Bold="True" Font-Names="Tahoma" 
                                                Font-Size="Medium" Text="Customer Password" ForeColor="#93C20F"></asp:Label>
                                        </td>
                                        <td class="style3">
                                            ...
                                            <asp:RequiredFieldValidator ID="pass_req" runat="server" 
                                                ...
                                                Font-Names="Tahoma" Font-Size="Medium" ForeColor="Red" 
                                                ToolTip="Entrer Password"></asp:RequiredFieldValidator>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td class="style2">
