...
namespace dcoffice
{
    public partial class townupdate : Form
    {
        public townupdate()
        {
            InitializeComponent();
        ...
        private void townupdate_Load(object sender, EventArgs e)
        {
            // TODO: This line of code loads data into the 'townttDataSet1.town' table. You can move, or remove it, as needed.
            this.townTableAdapter1.Fill(this.townttDataSet1.town);
        ...
        private void button4_Click(object sender, EventArgs e)
        {
            this.townTableAdapter1.Adapter.SelectCommand.Connection.Open();
            this.townTableAdapter1.Adapter.SelectCommand.CommandType = CommandType.Text;
            this.townTableAdapter1.Adapter.SelectCommand.CommandText = "delete from town where panchayatid = '" + this.comboBox1.Text + "'";
            this.townTableAdapter1.Adapter.SelectCommand.ExecuteNonQuery();
            this.townTableAdapter1.Adapter.SelectCommand.Connection.Close();
